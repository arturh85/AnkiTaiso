...
using PlayerLogic = state.PlayerLogic;
...
public partial class Player : CharacterBody3D, IPlayer, IProvide<IPlayerLogic> {
  ...
  [Dependency]
  public IGameRepo GameRepo => DependentExtensions.DependOn<IGameRepo>(this);

  [Dependency]
  public IAppRepo AppRepo => DependentExtensions.DependOn<IAppRepo>(this);
